...
async function createEditCustomerModal(data) {
  ...
  edit_order_details_modal_props.customers.defaultValue = { name: state.order.customer.name, title: state.order.customer.email };
                ...
                <div class="modal-dialog-scrollable modal-dialog show">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick="removeEditCustomerModal();"></button>
                        </div>
  ...
  $("div.modal-footer #update-customer-btn").on('click', async (e) => {
    ...
    customer = edit_order_details_modal_props.data.find(c => c.name === customer.name && c.email === customer.email)._id
    const orderData = {
        _id: state.order._id,
        customer,
