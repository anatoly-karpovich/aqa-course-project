function _createSidebar() {
  ...
  <div class="d-flex justify-content-center">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 200px;" id="sidebar">
      ...
      <li>
        <a href="#" class="nav-link active text-white" aria-current="page" onClick="sideMenuClickHandler('home');">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#home"></use></svg>
          Home
        </a>
      </li>
      <li>
        <a href="#" class="nav-link text-white" onClick="sideMenuClickHandler('orders');">
...
<li>
  <a href="#" class="nav-link text-white" onClick="sideMenuClickHandler(1);">
    <svg class="bi me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
    Dashboard
  </a>
</li>
<li>
  <a href="#" class="nav-link text-white" onClick="sideMenuClickHandler(2);">
    <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"></use></svg>
    Orders
  </a>
</li>
<li>
  <a href="#" class="nav-link text-white" onClick="sideMenuClickHandler(3);">
    <svg class="bi me-2" width="16" height="16"><use xlink:href="#grid"></use></svg>
    Products
  </a>
</li>
...
{/* <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link" onClick="sideMenuClickHandler(1);" href="#">Orders</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" onClick="sideMenuClickHandler(2);" href="#">Products</a>
      </li>
      <li class="nav-item">
